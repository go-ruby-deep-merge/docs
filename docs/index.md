# go-ruby-deep-merge documentation

**Pure-Go deep_merge — recursive hash/array merge with options (CGO=0).**

`go-ruby-deep-merge/deep-merge` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `deep-merge`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-deep-merge/deep-merge`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `deep-merge`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`deep-merge`](https://github.com/go-ruby-deep-merge/deep-merge) | the library — Ruby's `deep-merge` in pure Go |
| [`docs`](https://github.com/go-ruby-deep-merge/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-deep-merge.github.io`](https://github.com/go-ruby-deep-merge/go-ruby-deep-merge.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-deep-merge/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-deep-merge/deep-merge](https://github.com/go-ruby-deep-merge/deep-merge).
