...
The public API lives at the module root (`github.com/go-ruby-deep-merge/deep-merge`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `deep-merge`, while the surface follows
...
```go
import "github.com/go-ruby-deep-merge/deep-merge"
```
...
- **[pkg.go.dev/github.com/go-ruby-deep-merge/deep-merge](https://pkg.go.dev/github.com/go-ruby-deep-merge/deep-merge)**

The module's [README](https://github.com/go-ruby-deep-merge/deep-merge#readme) carries worked
